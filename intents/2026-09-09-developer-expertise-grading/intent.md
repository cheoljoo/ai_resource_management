...
2. **"등급을 나눈다"는 원래 요청의 핵심 산출물이 아직 없다.** 지금까지는 개별 지표를 정의하고
   ...
   구분/등급화"하는 로직·산출물은 존재하지 않는다. 반면 문서 7장(구 5장)은 "인사 평가 직접 연동 금지"를 원칙으로
...
- **Goodhart's Law 원칙(문서 1.3절, 구 1.2절)과 "인사 평가 직접 연동 금지"(문서 7장, 구 5장)를 반드시 준수** — 단일
